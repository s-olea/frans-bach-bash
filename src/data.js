...
export const ITINERARY = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        notes: "Reservation under Ian. 14–15 people (Cocos arrives Saturday). Classic steakhouse.",
      ...
      },
      {
        ...
        emoji: "🍸",
        name: "Bars — Bleau Bar",
        venue: "Bleau Bar, Fontainebleau",
        address: "2777 S Las Vegas Blvd, Las Vegas, NV 89109",
        notes: "Staying in/near the hotel. Bleau Bar at the Fontainebleau. No reservation needed.",
        who: "14–15",
        optional: true,
      },
      {
    ...
    events: [
      {
        ...
        notes: "10 people: Ian, Juan, Fran, Santi, Moy, Andres, Jero, Edu, Cocos, Chuchu. ~1.5 hrs.",
        who: "10",
        optional: true,
      },
      {
...
export const VENUES = [
  ...
  { name: "Bleau Bar", lat: 36.1368, lng: -115.1631, category: "Bar", day: "Friday", address: "2777 S Las Vegas Blvd (Fontainebleau)" },
